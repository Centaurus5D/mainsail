...
@Component
export default class Module5dPanelSettings extends Mixins(BaseMixin) {
    mdiCog = mdiCog
    ...
    set showPosition(newVal: boolean) {
        this.$store.dispatch('gui/saveSetting', { name: 'view.module5d.showPosition', value: newVal })
    }
    ...
    set showCoordinates(newVal: boolean) {
        this.$store.dispatch('gui/saveSetting', { name: 'view.module5d.showCoordinates', value: newVal })
    }
    ...
    set showControl(newVal: boolean) {
        this.$store.dispatch('gui/saveSetting', { name: 'view.module5d.showControl', value: newVal })
    }
}
</script>
